...
lab = Label(sp,text="Internet Speed Test",font=("Time New Roman",20,"bold"),bg="Green",fg="White")
...
button = Button(sp,text="Check Speed",font=("Time New Roman",20,"bold"),relief=RAISED,fg="red",bg="black",command=speedcheck)
button.place(x=40,y=430,height=50,width=380)
